...
const databaseConfig = {
  dbConnectURL: process.env.DB_CONNECTION_URL || 'mysql://data5hih6o2jwkpsb545:pscale_pw_6xY6sDDYqc5pi5bRuMfnnmkHtia4lPrEMwT33BbuTr4@aws.connect.psdb.cloud/design',
  name: "dormitory",
